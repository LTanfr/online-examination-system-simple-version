...
public partial class admin_AddExamination : System.Web.UI.Page
{
    ...
    protected void btnconfirm_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            //else
            //    isfb = "0";
            string str = "insert into tb_test(testContent,testAns1,testAns2,testAns3,testAns4,rightAns,testCourse) values('" + txtsubject.Text.Trim() + "','" + txtAnsA.Text.Trim() + "','" + txtAnsB.Text.Trim() + "','" + txtAnsC.Text.Trim() + "','" + txtAnsD.Text.Trim() + "','" + rblRightAns.SelectedValue.ToString() + "','" + ddlkm.SelectedItem.Text + "')";
