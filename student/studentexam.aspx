...
<body background="../Image/back_01.gif">
 ...
 <div style="text-align: center">
        ...
        <asp:Panel ID="Panel1" runat="server" Height="400px" Width="698px">
            <br />
            <br />
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 180px; height: 74px">
                        <tr>
                            <td style="width: 100px; text-align: center">
                                <asp:CheckBox ID="ckbCheck" runat="server" Text="已经仔细阅读了考试规则" Width="180px" />
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 100px; text-align: center" align="center">
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="同意考试规则" Width="181px" />
                            </td>
                        </tr>
                    </table>
                </div>
