...
<div style="text-align: center">
        ...
        <fieldset style="width: 556px; text-align: center">
            ...
            <asp:Button ID="below60btn" runat="server" Text="60分以下" OnClick="below60btn_Click"/>
            <asp:Button ID="beyond85btn" runat="server" Text="85分以上" OnClick="beyond85btn_Click"/>
            <asp:Button ID="output" runat="server" Text="导出" OnClick="output_Click"/>
            <br />
            <br />
            <br />
            <br />
